...
API_ID = int(os.environ.get("API_ID", "31830434"))

# Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "f5f89437fa7e2a1b37c2a734c05a5035")

# Your Owner / Admin Id For Broadcast 
ADMINS = int(os.environ.get("ADMINS", "7280426793"))
...
DB_URI = os.environ.get("DB_URI", "mongodb+srv://cryptob312_db_user:OoykJunPiibLZdJC@cluster0.zkg6qtv.mongodb.net/?appName=Cluster0") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
